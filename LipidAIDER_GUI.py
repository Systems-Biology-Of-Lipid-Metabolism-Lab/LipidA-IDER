...
def runAnalysis():
    ...
    # check the ms2 files (global variable list edit)
    ...
    for file in ms2_files_list:
        ...
        #analysis = AutoAnalyser(file=settings_filename_var.get(), ms2file=ms2_filename_var.get(), cores=multiprocessing.cpu_count())
